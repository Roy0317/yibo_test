package com.yibo.yiboapp.route.LDNetDiagnoService;
...
public class LDNetDiagnoService extends
    ...
    private int cmdsType = 2; //type 1 = PING  type 2 = TRACE_ROUTE  type 3 = HTTP
    ...
    public LDNetDiagnoService(Context context, String theAppCode,
                              ...
                              String theMobileNetCode, LDNetDiagnoListener theListener, String encrptDomain, int cmdsType) {
        super();
        ...
        this._encrptDomain = encrptDomain;
        this._isRunning = false;
        this.cmdsType = cmdsType;
...
//                _localIp = LDNetUtil.getLocalIpBy3G();
            ...
            recordStepInfo("IP信息:\t" + _localIp);
        } else {
            recordStepInfo("本地IP:\t" + "127.0.0.1");
        }

        String domainUrl = "标识:\t" + _encrptDomain;
        recordStepInfo(domainUrl);
