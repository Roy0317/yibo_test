 ...
 * @author johnson
 */
public class BaseActivity extends VeryBaseActivity implements OnClickListener {
    ...
    protected void initView() {
        ...
        if (mLayout != null) {
            ...
            tvThirdRightText = (TextView) mLayout.findViewById(R.id.third_right_text);
...
//        if (!handleHttpError(response.result)) {
//            return false;
//        }
//        判断网站是否在维护中
        if (response != null){
    ...
    protected Intent fillIntent(Intent intent) {
        intent.putExtra(RequestUtils.NATIVE_HOST, Urls.BASE_HOST_URL);
        intent.putExtra(RequestUtils.NATIVE_DOMAIN, Urls.BASE_URL);
