...
import com.simon.widget.skinlibrary.SkinItem;
...
//                    LogUtil.d(TAG, "    textColor in style is supported:" + "\n" +
...
//                    LogUtil.d(TAG, "    background in style is supported:" + "\n" +
...
//                    LogUtil.d(TAG, "    " + attrName + " is supported:" + "\n" +
//                            "    resource id:" + id + "\n" +
//                            "    attrName:" + attrName + "\n" +
//                            "    attrValue:" + attrValue + "\n" +
//                            "    entryName:" + entryName + "\n" +
...
//                    );
        ...
        if (!SkinListUtils.isEmpty(viewAttrs)) {
            ...
            if (SkinManager.getInstance().isExternalSkin() ||
                    SkinManager.getInstance().isExtendMode()) {//如果当前皮肤来自于网络下载
                skinItem.apply();
            }
        }
    }
