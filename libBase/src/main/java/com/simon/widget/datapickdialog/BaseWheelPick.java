package com.simon.widget.datapickdialog;
...
import com.simon.R;
import com.simon.widget.datapickdialog.genview.GenWheelText;
import com.simon.widget.datapickdialog.genview.WheelGeneralAdapter;
import com.simon.widget.datapickdialog.view.OnWheelChangedListener;
...
abstract class BaseWheelPick
    ...
    //选中的颜色
    protected int selectColor = 0xffec2829;
    ...
    public BaseWheelPick(Context context, AttributeSet attrs) {
        ...
        selectColor = a.getColor(R.styleable.DatePicker_picker_select_textColor, 0xffec2829);
