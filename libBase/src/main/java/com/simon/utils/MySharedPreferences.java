...
public class MySharedPreferences {
     ...
     * @param context 上下文
     * @param filename 文件名
     * @param model 写入模式默认Context.MODE_PRIVATE模式</br> Context.MODE_PRIVATE
     *            私有模式且覆盖原有数据；</br>Context.MODE_MULTI_PROCESS 私有追加不覆盖数据</br>
     *            Context.MODE_WORLD_READABLE
     *            可被其他程序读；</br>Context.MODE_WORLD_WRITEABLE 可被其他程序写；</br>Context.MODE_MULTI_PROCESS  跨进程读写
     */
    public MySharedPreferences(Context context, String filename, int model) {
     ...
     * @param sp
     */
    public MySharedPreferences(Context context, SharedPreferences sp) {
