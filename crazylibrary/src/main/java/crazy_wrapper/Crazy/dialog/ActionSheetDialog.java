...
//    private View v_line_title;
     ...
     */
    private int titleBgColor = Color.parseColor("#EC2829");
    /**
     * title text(标题)
     */
     ...
     */
    private int dividerColor = Color.parseColor("#c5c5c5");
    /**
     * divider height(ListView divider高度)
     */
    private float dividerHeight_DP = 0.5f;
    /**
...
//        v_line_title.setVisibility(isTitleShow ? View.VISIBLE : View.GONE);
        ...
        if (isTitleShow) {
            lv.setBackgroundDrawable(CornerUtils.cornerDrawable(lvBgColor, new float[]{0, 0, 0, 0, radius, radius, radius,radius}));
        } else {
        ...
        //zhangy modify 20161017 to dismiss listview animation when show list dialog.
