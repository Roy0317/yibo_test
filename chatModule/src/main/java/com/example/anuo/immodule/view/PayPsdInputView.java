...
public class PayPsdInputView extends AppCompatEditText {
    ...
    private void getAtt(AttributeSet attrs) {
        ...
        radius = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputView_borderRadius, radius);
        ...
        if (textLength == maxCount) {
            if (mListener != null) {
                if (TextUtils.isEmpty(mComparePassword)) {
                    ...
                    if (!TextUtils.isEmpty(getPasswordString()) && mComparePassword.length() == getPasswordString().length()) {
