package com.example.anuo.immodule.emoji;
...
public class EmojiDao {
    ...
    public static String CopySqliteFileFromRawToDatabases(String SqliteFileName) throws IOException {
        ...
        File dir = new File("data/data/" + ctx.getApplicationInfo().processName + "/databases");
        ...
        if (!file.exists()) {
            try {
                file.createNewFile();
                inputStream = ChatMainActivity.class.getClassLoader().getResourceAsStream("assets/" + SqliteFileName);
