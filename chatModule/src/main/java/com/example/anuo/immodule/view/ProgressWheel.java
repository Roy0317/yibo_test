...
public class ProgressWheel extends View {
    ...
    public ProgressWheel(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs,
                com.meiya.cunnar.crazy.crazylibrary.R.styleable.ProgressWheel));
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(com.meiya.cunnar.crazy.crazylibrary.R.styleable.ProgressWheel_circleRadius, circleRadius);
        Utils.LOG(TAG, "the cirsle radius =========== " + circleRadius);

        fillRadius = a.getBoolean(com.meiya.cunnar.crazy.crazylibrary.R.styleable.ProgressWheel_fillRadius, false);

        barWidth = (int) a.getDimension(com.meiya.cunnar.crazy.crazylibrary.R.styleable.ProgressWheel_barWidth, barWidth);

        rimWidth = (int) a.getDimension(com.meiya.cunnar.crazy.crazylibrary.R.styleable.ProgressWheel_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(com.meiya.cunnar.crazy.crazylibrary.R.styleable.ProgressWheel_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(com.meiya.cunnar.crazy.crazylibrary.R.styleable.ProgressWheel_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(com.meiya.cunnar.crazy.crazylibrary.R.styleable.ProgressWheel_barColor, barColor);

        rimColor = a.getColor(com.meiya.cunnar.crazy.crazylibrary.R.styleable.ProgressWheel_rimColor, rimColor);

        if (a.getBoolean(com.meiya.cunnar.crazy.crazylibrary.R.styleable.ProgressWheel_progressIndeterminate, false)) {
            spin();
        }
