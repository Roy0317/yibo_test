...
public class DropDownMenu extends LinearLayout {
     ...
     * @param text
     */
    public void setTabTextMaunal(String text,int tabIndex) {

        int count = tabMenuView.getChildCount();
        if (tabIndex != -1 && tabMenuView.getChildCount() > tabIndex+1) {
            ((TextView) tabMenuView.getChildAt(tabIndex+1)).setText(text);
        }
    }
